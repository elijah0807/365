...
const HomeScreen = () => {
  ...
  const fetchCat = () => {
    var apiUrl = "https://bestbuy.space/getcategories.php"; //API to render signup
  ...
  const fetchProduct = () => {
    var apiUrl = "https://bestbuy.space/get_products.php"; //API to render signup
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate({ name: "Products", params: {
                      products: products,
                      catId: item.id,
                      catName: item.name
                    } });
